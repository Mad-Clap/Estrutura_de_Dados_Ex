...
public class Arvbin<T extends Comparable<T>>
{
    ...
    public static Integer retornaSomaSubarvore(Arvbin<Integer> no) {
        ...
        // Soma o valor do nó com o valor na subárvore esquerda e direita, se existirem.
        // Se não existirem (forem null), retorna 0, pela condição no início do método
        soma += no.val;
        soma += retornaSomaSubarvore(no.esq);
        soma += retornaSomaSubarvore(no.dir);

        // Retorna o valor da soma obtida
        return soma;
    }
