...
public class Arvbin<T extends Comparable<T>>
{
    ...
    {
        System.out.print("(" + val);
        if (esq != null) esq.imprimePreOrdem();

        if (dir != null) dir.imprimePreOrdem();
        System.out.print(")");
    }
    ...
    {
        System.out.print("(");
        if (esq != null) esq.imprimePosOrdem();

        if (dir != null) dir.imprimePosOrdem();
        System.out.print(val + ")");
    }
    ...
    {
        System.out.print("(");
        if (esq != null) esq.imprimeEmOrdem();
        System.out.print(val);

        if (dir != null) dir.imprimeEmOrdem();
        System.out.print(")");
    }
}
