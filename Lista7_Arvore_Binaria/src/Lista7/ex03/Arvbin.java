...
public class Arvbin<T extends Comparable<T>>
{
    ...
    public boolean eSimilar(Arvbin<T> arvore){
        ...
        //Se as duas árvores chegaram em suas folhas simplesmente retorna true
        if((dir == null && esq == null) && (arvore.dir == null && arvore.esq == null)) return true;

        //Se uma árvore tem mais nós que a outra retorna false
       if((dir == null && arvore.dir != null) || (esq != null && arvore.esq == null)) return false;
